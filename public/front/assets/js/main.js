...
(function ($) {
    ...
    $(".dark").on("click", function (e) {
        ...
        document.getElementById("logo_header").src =
            "/front/assets/images/logo/logo_dark.png";
        document.getElementById("logo_footer").src =
            "/front/assets/images/logo/logo_dark.png";
        document.getElementById("moon_dark").src =
            "/front/assets/images/icon/moon-2.png";
    });
    ...
    $(".light").on("click", function (e) {
        ...
        document.getElementById("logo_header").src =
            "/front/assets/images/logo/logo.png";
        document.getElementById("logo_footer").src =
            "/front/assets/images/logo/logo2.png";
        document.getElementById("moon_dark").src =
            "/front/assets/images/icon/moon.png";
    });
