...
@section('title', $market_item->title)
@section('content')
                ...
                <div class="col-md-12">
                    ...
                    <div class="breadcrumbs style2">
                        <ul>
                            ...
                            <li><a
                                    href="{{ route('category', $market_item->category->id) }}">{{ $market_item->category->category_name }}</a>
                            </li>
                                ...
                                <ul>
                                    @foreach ($market_item->platforms as $platform)
                                        <li class="link"><a target="_blank"
                                                href="{{ $platform->link }}"><i>{{ $platform->platform->title }}</i></a>
                                        </li>
                                    @endforeach
