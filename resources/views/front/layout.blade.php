...
<head>
    ...
    @section('title', 'Home')
    <title>NFTLAB - @yield('title')</title>
    ...
    <link rel="apple-touch-icon-precomposed" href="{{ asset('front/assets/icon/Favicon.png') }}">
...
<body class="body header-fixed is_dark">
            ...
            <header id="header_main" class="header_1 js-header">
                                    ...
                                    <div id="site-logo" class="clearfix">
                                        <div id="site-logo-inner">
                                            <a href="/" rel="home" class="main-logo">
                                                ...
                                                <img id="logo_header"
                                                    src="{{ asset('front/assets/images/logo/logo_dark.png') }}"
                                                    alt="nft-gaming" width="133" height="56"
                                                    data-retina="{{ asset('front/assets/images/logo/logo_dark@2x.png') }}"
                ...
                <div class="mode_switcher">
                    ...
                    <a href="#" class="light d-flex align-items-center">
                        <img src="{{ asset('front/assets/images/icon/sun.png') }}" alt="">

                    </a>
                    <a href="#" class="dark d-flex align-items-center is_active">
                        <img id="moon_dark" src="{{ asset('front/assets/images/icon/moon-2.png') }}" alt="">
                            ...
                            <div class="widget widget-logo">
                                <div class="logo-footer" id="logo-footer">
                                    <a href="index.html">
                                        <img id="logo_footer"
                                            src="{{ asset('front/assets/images/logo/logo_dark.png') }}  "
                                            alt="nft-gaming" width="135" height="56"
                                            data-retina="{{ asset('front/assets/images/logo/logo_dark2x.png') }}  "
                                            data-width="135" data-height="56">
                                    </a>
                                </div>
                                <p class="sub-widget-logo">Lorem ipsum dolor sit amet,consectetur adipisicing elit. Quis
                                    non, fugit totam vel laboriosam vitae.</p>
                            </div>
                        </div>
                            ...
                            <div class="widget widget-subcribe">
                                ...
                                <div class="widget-social style-1 mg-t32">
                                    <ul>
                                        ...
                                        <li class="style-2"><a href="#"><i class="fab fa-instagram"></i></a>
                                        </li>
    ...
    @section('js')
        ...
        <script src="{{ asset('front/assets/js/web3.min.js') }}"></script>
        <script src="{{ asset('front/assets/js/moralis.js') }}"></script>
        <script src="{{ asset('front/assets/js/nft.js') }}"></script>
    @show
