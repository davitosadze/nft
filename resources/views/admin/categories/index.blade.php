                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            ...
                            <a class="btn-icon btn btn-primary btn-round btn-md" type="button" href="{{route('admin.categories.create')}}"><i
                                data-feather="plus"></i>Add Record</a>
                        </div>
                        <div class="card-datatable">
                            <table class="dt-column-search table" id="categoriesTable">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Category Name</th>
