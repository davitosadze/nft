...
{{--                            <span class="user-name font-weight-bolder">{{auth()->user()->name}}</span>--}}
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="{{ request()->is('admin') ? 'active' : '' }} nav-item">
                    <a class="d-flex align-items-center" href="{{ route("admin.home") }}">
                        <i data-feather="home"></i><span class="menu-title text-truncate"
                                                          data-i18n="Email">Dashboard</span>
                    </a>
                </li>

                <li class="{{ request()->is('admin/market') ? 'active' : '' }} nav-item">
                    <a class="d-flex align-items-center" href="{{ route("admin.market.index") }}">
                        <i data-feather="home"></i><span class="menu-title text-truncate"
                                                          data-i18n="Email">Market</span>
                    </a>
                </li>
                ...
                <li class="{{ request()->is('admin/categories') ? 'active' : '' }} nav-item">
                    <a class="d-flex align-items-center" href="{{ route("admin.categories.index") }}">
                        <i data-feather="home"></i><span class="menu-title text-truncate"
                                                          data-i18n="Email">Categories</span>
                    </a>
                </li>

                <li class="{{ request()->is('admin/platforms') ? 'active' : '' }} nav-item">
                    <a class="d-flex align-items-center" href="{{ route("admin.platforms.index") }}">
                        <i data-feather="home"></i><span class="menu-title text-truncate"
                                                          data-i18n="Email">Platforms</span>
                    </a>
                </li>
    ...
    <div class="modal modal-slide-in event-sidebar fade" id="bookingDetails">
...
.bg-confirmed {
    background-color:#3fff0057;
}
.bg-delivered {
    background-color:#7265dd4f;
}
.bg-canceled {
...
@section('js')
    ...
    <script src="{{asset('js/notifications/push-system.js')}}"></script>
    <script src="{{asset('js/notifications/push-orders.js')}}"></script>

    <script src="{{asset('js/sidebarDetails/details.js')}}"></script>
